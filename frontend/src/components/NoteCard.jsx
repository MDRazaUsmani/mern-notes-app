...
const NoteCard = ({ note, setNotes }) => { 
    //from {<NoteCard key={note._id} note={note} setNotes={setNotes}/> in Homepage.jsx and /note from app.jsx
    const handleDelete = async (e, id) => {
        ...
        try {
            ...
            setNotes((prev) => prev.filter(note => note._id!==id)) // this is used to update the UI once the deletion occurs
